...
// ---- GAF-SPECIFIC FASTENER OPTIONS (Drill-Tec catalog) ----

export const GAF_INSULATION_SCREW_TYPES = [
  { value: "gaf-drilltec-12", label: "GAF Drill-Tec #12 Fastener" },
  { value: "gaf-drilltec-14", label: "GAF Drill-Tec #14 Fastener" },
  { value: "gaf-drilltec-xhd-15", label: "GAF Drill-Tec XHD #15 Fastener" },
  { value: "gaf-drilltec-ld", label: "GAF Drill-Tec LD (Lite-Deck / Gypsum)" },
  { value: "gaf-drilltec-cd10", label: "GAF Drill-Tec CD-10 (Concrete)" },
];

// GAF Drill-Tec #12: 1-5/8" to 8" | #14: 1-1/4" to 24" | XHD #15: 2" to 22"
export const GAF_INSULATION_SCREW_LENGTHS = [
  { value: "auto", label: "Auto-Select (based on assembly)" },
  { value: "1.25in", label: '1-1/4" (#14 only)' },
  { value: "1.625in", label: '1-5/8" (#12)' },
  { value: "1.75in", label: '1-3/4" (#14 only)' },
  { value: "2in", label: '2"' },
  { value: "2.25in", label: '2-1/4" (#12)' },
  { value: "2.625in", label: '2-5/8" (LD only)' },
  { value: "3in", label: '3"' },
  { value: "4in", label: '4"' },
  { value: "5in", label: '5"' },
  { value: "6in", label: '6"' },
  { value: "7in", label: '7"' },
  { value: "8in", label: '8"' },
  { value: "9in", label: '9" (#14/XHD #15)' },
  { value: "10in", label: '10" (#14/XHD #15)' },
  { value: "11in", label: '11" (#14/XHD #15)' },
  { value: "12in", label: '12" (#14/XHD #15)' },
  { value: "14in", label: '14" (#14/XHD #15)' },
  { value: "16in", label: '16" (#14/XHD #15)' },
  { value: "18in", label: '18" (#14/XHD #15)' },
  { value: "20in", label: '20" (#14/XHD #15)' },
  { value: "22in", label: '22" (#14/XHD #15)' },
  { value: "24in", label: '24" (#14 only)' },
];

// GAF Drill-Tec XHD #15 membrane screw lengths: 2" to 22"
export const GAF_MEMBRANE_SCREW_LENGTHS = [
  { value: "auto", label: "Auto-Select (based on assembly)" },
  { value: "2in", label: '2"' },
  { value: "3in", label: '3"' },
  { value: "4in", label: '4"' },
...
export const GAF_TPO_PRODUCTS: Record<string, TPOProduct> = {
  ...
  // ---- GAF DRILL-TEC INSULATION SCREWS (complete catalog) ----
  // #12: 1-5/8" to 8" | #14: 1-1/4" to 24" | XHD #15: 2" to 22" | LD: 2-5/8" to 12" | CD-10: 1-1/4" to 8"
  "fastener-screws-1.25in": {
    id: "fastener-screws-1.25in", name: 'Drill-Tec #14 x 1-1/4" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 55, description: "GAF Drill-Tec #14 — 1-1/4\" for minimal assemblies",
  },
  "fastener-screws-1.625in": {
    id: "fastener-screws-1.625in", name: 'Drill-Tec #12 x 1-5/8" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 58, description: "GAF Drill-Tec #12 — 1-5/8\" for thin assemblies",
  },
  "fastener-screws-1.75in": {
    id: "fastener-screws-1.75in", name: 'Drill-Tec #14 x 1-3/4" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 60, description: "GAF Drill-Tec #14 — 1-3/4\" for thin assemblies",
  },
  "fastener-screws-2in": {
    id: "fastener-screws-2in", name: 'Drill-Tec #14 x 2" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 67, description: "GAF Drill-Tec #14 — 2\" for assemblies up to 1\" insulation",
  },
  "fastener-screws-2.25in": {
    id: "fastener-screws-2.25in", name: 'Drill-Tec #12 x 2-1/4" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 70, description: "GAF Drill-Tec #12 — 2-1/4\" for light assemblies",
  },
  "fastener-screws-2.625in": {
    id: "fastener-screws-2.625in", name: 'Drill-Tec LD x 2-5/8" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 72, description: "GAF Drill-Tec LD — 2-5/8\" for gypsum/cementitious decks",
  },
  "fastener-screws-3in": {
    id: "fastener-screws-3in", name: 'Drill-Tec #14 x 3" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 78, description: "GAF Drill-Tec #14 — 3\" for 1\"-2\" insulation assemblies",
  },
  "fastener-screws-4in": {
    id: "fastener-screws-4in", name: 'Drill-Tec #14 x 4" Fastener',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 95, description: "GAF Drill-Tec #14 — 4\" for 2\"-3\" insulation assemblies",
  },
  "fastener-screws-5in": {
    id: "fastener-screws-5in", name: 'Drill-Tec #14 x 5" Fastener',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 72, description: "GAF Drill-Tec #14 — 5\" for 3\"-4\" insulation assemblies",
  },
  "fastener-screws-6in": {
    id: "fastener-screws-6in", name: 'Drill-Tec #14 x 6" Fastener',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 82, description: "GAF Drill-Tec #14 — 6\" for 4\"-5\" insulation assemblies",
  },
  "fastener-screws-7in": {
    id: "fastener-screws-7in", name: 'Drill-Tec #14 x 7" Fastener',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 92, description: "GAF Drill-Tec #14 — 7\" for 5\"-6\" insulation assemblies",
  },
  "fastener-screws-8in": {
    id: "fastener-screws-8in", name: 'Drill-Tec #14 x 8" Fastener',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 105, description: "GAF Drill-Tec #14 — 8\" for 6\"+ insulation assemblies",
  },
  "fastener-screws-9in": {
    id: "fastener-screws-9in", name: 'Drill-Tec #14 x 9" Fastener',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 115, description: "GAF Drill-Tec #14 — 9\" for deep insulation assemblies",
  },
  "fastener-screws-10in": {
    id: "fastener-screws-10in", name: 'Drill-Tec #14 x 10" Fastener',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 128, description: "GAF Drill-Tec #14 — 10\" for deep insulation assemblies",
  },
  "fastener-screws-11in": {
    id: "fastener-screws-11in", name: 'Drill-Tec #14 x 11" Fastener',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 135, description: "GAF Drill-Tec #14 — 11\" for deep insulation assemblies",
  },
  "fastener-screws-12in": {
    id: "fastener-screws-12in", name: 'Drill-Tec #14 x 12" Fastener',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 85, description: "GAF Drill-Tec #14 — 12\" for re-roof / deep assemblies",
  },
  "fastener-screws-14in": {
    id: "fastener-screws-14in", name: 'Drill-Tec #14 x 14" Fastener',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 95, description: "GAF Drill-Tec #14 — 14\" for re-roof / deep assemblies",
  },
  "fastener-screws-16in": {
    id: "fastener-screws-16in", name: 'Drill-Tec #14 x 16" Fastener',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 108, description: "GAF Drill-Tec #14 — 16\" for re-roof / deep assemblies",
  },
  "fastener-screws-18in": {
    id: "fastener-screws-18in", name: 'Drill-Tec #14 x 18" Fastener',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 120, description: "GAF Drill-Tec #14 — 18\" for re-roof / deep assemblies",
  },
  "fastener-screws-20in": {
    id: "fastener-screws-20in", name: 'Drill-Tec #14 x 20" Fastener',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 135, description: "GAF Drill-Tec #14 — 20\" for re-roof / deep assemblies",
  },
  "fastener-screws-22in": {
    id: "fastener-screws-22in", name: 'Drill-Tec #14 x 22" Fastener',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 148, description: "GAF Drill-Tec #14 — 22\" for re-roof / deep assemblies",
  },
  "fastener-screws-24in": {
    id: "fastener-screws-24in", name: 'Drill-Tec #14 x 24" Fastener',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 162, description: "GAF Drill-Tec #14 — 24\" for re-roof / deep assemblies",
  },

  // ---- GAF DRILL-TEC XHD #15 MEMBRANE SCREWS (complete catalog: 2" to 22") ----
  "fastener-screws-membrane-2in": {
    id: "fastener-screws-membrane-2in", name: 'Drill-Tec XHD #15 x 2" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 72, description: "GAF Drill-Tec XHD #15 — 2\" for seam attachment",
  },
  "fastener-screws-membrane-3in": {
    id: "fastener-screws-membrane-3in", name: 'Drill-Tec XHD #15 x 3" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 82, description: "GAF Drill-Tec XHD #15 — 3\" for seam attachment",
  },
  "fastener-screws-membrane-4in": {
    id: "fastener-screws-membrane-4in", name: 'Drill-Tec XHD #15 x 4" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 95, description: "GAF Drill-Tec XHD #15 — 4\" for seam attachment",
  },
  "fastener-screws-membrane-5in": {
    id: "fastener-screws-membrane-5in", name: 'Drill-Tec XHD #15 x 5" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 65, description: "GAF Drill-Tec XHD #15 — 5\" for seam attachment",
  },
  "fastener-screws-membrane-6in": {
    id: "fastener-screws-membrane-6in", name: 'Drill-Tec XHD #15 x 6" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 75, description: "GAF Drill-Tec XHD #15 — 6\" for seam attachment",
  },
  "fastener-screws-membrane-7in": {
    id: "fastener-screws-membrane-7in", name: 'Drill-Tec XHD #15 x 7" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 85, description: "GAF Drill-Tec XHD #15 — 7\" for seam attachment",
  },
  "fastener-screws-membrane-8in": {
    id: "fastener-screws-membrane-8in", name: 'Drill-Tec XHD #15 x 8" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 95, description: "GAF Drill-Tec XHD #15 — 8\" for seam attachment",
  },
  "fastener-screws-membrane-9in": {
    id: "fastener-screws-membrane-9in", name: 'Drill-Tec XHD #15 x 9" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 105, description: "GAF Drill-Tec XHD #15 — 9\" for seam attachment",
  },
  "fastener-screws-membrane-10in": {
    id: "fastener-screws-membrane-10in", name: 'Drill-Tec XHD #15 x 10" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 118, description: "GAF Drill-Tec XHD #15 — 10\" for seam attachment",
  },
  "fastener-screws-membrane-11in": {
    id: "fastener-screws-membrane-11in", name: 'Drill-Tec XHD #15 x 11" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 128, description: "GAF Drill-Tec XHD #15 — 11\" for seam attachment",
  },
  "fastener-screws-membrane-12in": {
    id: "fastener-screws-membrane-12in", name: 'Drill-Tec XHD #15 x 12" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 135, description: "GAF Drill-Tec XHD #15 — 12\" for seam attachment",
  },
  "fastener-screws-membrane-14in": {
    id: "fastener-screws-membrane-14in", name: 'Drill-Tec XHD #15 x 14" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 82, description: "GAF Drill-Tec XHD #15 — 14\" for seam attachment",
  },
  "fastener-screws-membrane-16in": {
    id: "fastener-screws-membrane-16in", name: 'Drill-Tec XHD #15 x 16" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 95, description: "GAF Drill-Tec XHD #15 — 16\" for seam attachment",
  },
  "fastener-screws-membrane-18in": {
    id: "fastener-screws-membrane-18in", name: 'Drill-Tec XHD #15 x 18" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 108, description: "GAF Drill-Tec XHD #15 — 18\" for seam attachment",
  },
  "fastener-screws-membrane-20in": {
    id: "fastener-screws-membrane-20in", name: 'Drill-Tec XHD #15 x 20" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 120, description: "GAF Drill-Tec XHD #15 — 20\" for seam attachment",
  },
  "fastener-screws-membrane-22in": {
    id: "fastener-screws-membrane-22in", name: 'Drill-Tec XHD #15 x 22" Membrane Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 135, description: "GAF Drill-Tec XHD #15 — 22\" for seam attachment",
  },
...
export function calculateGAFTPOEstimate(
  ...
  if (totalInsThickness > 0) {
    if (assembly.attachmentMethod === "mechanically-attached") {
      ...
      const screwTypeName = GAF_INSULATION_SCREW_TYPES.find(t => t.value === assembly.fastenerType)?.label ?? "Drill-Tec Roofing Fastener";
      addItem(
        screwId,
        screwBoxes,
