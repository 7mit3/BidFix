...
// SFS Dekfast / Trufast / OMG screw lengths for Carlisle systems
// #12: 1-5/8" to 8" | #14: 1-1/4" to 24" | #15: 2" to 24"
export const INSULATION_SCREW_LENGTHS = [
  ...
  { value: "7in", label: '7"' },
  { value: "8in", label: '8"' },
  { value: "9in", label: '9" (#14/#15)' },
  { value: "10in", label: '10" (#14/#15)' },
  { value: "12in", label: '12" (#14/#15)' },
  { value: "14in", label: '14" (#14/#15)' },
  { value: "16in", label: '16" (#14/#15)' },
  { value: "18in", label: '18" (#14/#15)' },
  { value: "20in", label: '20" (#14/#15)' },
  { value: "22in", label: '22" (#14/#15)' },
  { value: "24in", label: '24" (#14 only)' },
];

// SFS Dekfast #15 / Trufast #15 EHD membrane screw lengths: 2" to 24"
...
export const TPO_PRODUCTS: Record<string, TPOProduct> = {
  ...
  // ---- INSULATION SCREWS — SFS Dekfast / Trufast / OMG (complete catalog) ----
  // #12: 1-5/8" to 8" (steel 22-24ga, wood) | #14: 1-1/4" to 24" (heavy steel 18-20ga, wood, concrete)
  "fastener-screws-1.25in": {
    id: "fastener-screws-1.25in", name: '#14 x 1-1/4" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 55, description: "SFS Dekfast #14 — 1-1/4\" for minimal assemblies",
  },
  "fastener-screws-1.625in": {
    id: "fastener-screws-1.625in", name: '#12 x 1-5/8" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 58, description: "SFS Dekfast #12 — 1-5/8\" for thin assemblies",
  },
  "fastener-screws-1.75in": {
    id: "fastener-screws-1.75in", name: '#14 x 1-3/4" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 60, description: "SFS Dekfast #14 — 1-3/4\" for thin assemblies",
  },
  "fastener-screws-2in": {
    id: "fastener-screws-2in", name: '#14 x 2" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 67, description: "SFS Dekfast #14 — 2\" for assemblies up to 1\" insulation",
  },
  "fastener-screws-2.25in": {
    id: "fastener-screws-2.25in", name: '#12 x 2-1/4" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 70, description: "SFS Dekfast #12 — 2-1/4\" for light assemblies",
  },
  "fastener-screws-3in": {
    id: "fastener-screws-3in", name: '#14 x 3" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 78, description: "SFS Dekfast #14 — 3\" for 1\"-2\" insulation assemblies",
  },
  "fastener-screws-4in": {
    id: "fastener-screws-4in", name: '#14 x 4" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 95, description: "SFS Dekfast #14 — 4\" for 2\"-3\" insulation assemblies",
  },
  "fastener-screws-5in": {
    id: "fastener-screws-5in", name: '#14 x 5" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 72, description: "SFS Dekfast #14 — 5\" for 3\"-4\" insulation assemblies",
  },
  "fastener-screws-6in": {
    id: "fastener-screws-6in", name: '#14 x 6" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 82, description: "SFS Dekfast #14 — 6\" for 4\"-5\" insulation assemblies",
  },
  "fastener-screws-7in": {
    id: "fastener-screws-7in", name: '#14 x 7" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 92, description: "SFS Dekfast #14 — 7\" for 5\"-6\" insulation assemblies",
  },
  "fastener-screws-8in": {
    id: "fastener-screws-8in", name: '#14 x 8" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 105, description: "SFS Dekfast #14 — 8\" for 6\"+ insulation assemblies",
  },
  "fastener-screws-9in": {
    id: "fastener-screws-9in", name: '#14 x 9" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 115, description: "SFS Dekfast #14 — 9\" for deep insulation assemblies",
  },
  "fastener-screws-10in": {
    id: "fastener-screws-10in", name: '#14 x 10" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 128, description: "SFS Dekfast #14 — 10\" for deep insulation assemblies",
  },
  "fastener-screws-12in": {
    id: "fastener-screws-12in", name: '#14 x 12" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 85, description: "SFS Dekfast #14 — 12\" for re-roof / deep assemblies",
  },
  "fastener-screws-14in": {
    id: "fastener-screws-14in", name: '#14 x 14" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 95, description: "SFS Dekfast #14 — 14\" for re-roof / deep assemblies",
  },
  "fastener-screws-16in": {
    id: "fastener-screws-16in", name: '#14 x 16" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 108, description: "SFS Dekfast #14 — 16\" for re-roof / deep assemblies",
  },
  "fastener-screws-18in": {
    id: "fastener-screws-18in", name: '#14 x 18" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 120, description: "SFS Dekfast #14 — 18\" for re-roof / deep assemblies",
  },
  "fastener-screws-20in": {
    id: "fastener-screws-20in", name: '#14 x 20" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 135, description: "SFS Dekfast #14 — 20\" for re-roof / deep assemblies",
  },
  "fastener-screws-22in": {
    id: "fastener-screws-22in", name: '#14 x 22" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 148, description: "SFS Dekfast #14 — 22\" for re-roof / deep assemblies",
  },
  "fastener-screws-24in": {
    id: "fastener-screws-24in", name: '#14 x 24" HD Roofing Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 162, description: "SFS Dekfast #14 — 24\" for re-roof / deep assemblies",
  },

  // ---- MEMBRANE SCREWS — SFS Dekfast #15 / Trufast #15 EHD (complete catalog: 2" to 24") ----
  "fastener-screws-membrane-2in": {
    id: "fastener-screws-membrane-2in", name: '#15 x 2" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 72, description: "#15 XHD membrane screws — 2\" for seam attachment",
  },
  "fastener-screws-membrane-3in": {
    id: "fastener-screws-membrane-3in", name: '#15 x 3" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 82, description: "#15 XHD membrane screws — 3\" for seam attachment",
  },
  "fastener-screws-membrane-4in": {
    id: "fastener-screws-membrane-4in", name: '#15 x 4" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (1,000)", coveragePerUnit: 1000, coverageUnit: "pieces",
    defaultPrice: 95, description: "#15 XHD membrane screws — 4\" for seam attachment",
  },
  "fastener-screws-membrane-5in": {
    id: "fastener-screws-membrane-5in", name: '#15 x 5" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 65, description: "#15 XHD membrane screws — 5\" for seam attachment",
  },
  "fastener-screws-membrane-6in": {
    id: "fastener-screws-membrane-6in", name: '#15 x 6" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 75, description: "#15 XHD membrane screws — 6\" for seam attachment",
  },
  "fastener-screws-membrane-7in": {
    id: "fastener-screws-membrane-7in", name: '#15 x 7" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 85, description: "#15 XHD membrane screws — 7\" for seam attachment",
  },
  "fastener-screws-membrane-8in": {
    id: "fastener-screws-membrane-8in", name: '#15 x 8" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 95, description: "#15 XHD membrane screws — 8\" for seam attachment",
  },
  "fastener-screws-membrane-9in": {
    id: "fastener-screws-membrane-9in", name: '#15 x 9" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 105, description: "#15 XHD membrane screws — 9\" for seam attachment",
  },
  "fastener-screws-membrane-10in": {
    id: "fastener-screws-membrane-10in", name: '#15 x 10" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 118, description: "#15 XHD membrane screws — 10\" for seam attachment",
  },
  "fastener-screws-membrane-12in": {
    id: "fastener-screws-membrane-12in", name: '#15 x 12" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (500)", coveragePerUnit: 500, coverageUnit: "pieces",
    defaultPrice: 135, description: "#15 XHD membrane screws — 12\" for seam attachment",
  },
  "fastener-screws-membrane-14in": {
    id: "fastener-screws-membrane-14in", name: '#15 x 14" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 82, description: "#15 XHD membrane screws — 14\" for seam attachment",
  },
  "fastener-screws-membrane-16in": {
    id: "fastener-screws-membrane-16in", name: '#15 x 16" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 95, description: "#15 XHD membrane screws — 16\" for seam attachment",
  },
  "fastener-screws-membrane-18in": {
    id: "fastener-screws-membrane-18in", name: '#15 x 18" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 108, description: "#15 XHD membrane screws — 18\" for seam attachment",
  },
  "fastener-screws-membrane-20in": {
    id: "fastener-screws-membrane-20in", name: '#15 x 20" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 120, description: "#15 XHD membrane screws — 20\" for seam attachment",
  },
  "fastener-screws-membrane-22in": {
    id: "fastener-screws-membrane-22in", name: '#15 x 22" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 135, description: "#15 XHD membrane screws — 22\" for seam attachment",
  },
  "fastener-screws-membrane-24in": {
    id: "fastener-screws-membrane-24in", name: '#15 x 24" Membrane Attachment Screws',
    category: "Fasteners & Plates", unit: "Box (250)", coveragePerUnit: 250, coverageUnit: "pieces",
    defaultPrice: 148, description: "#15 XHD membrane screws — 24\" for seam attachment",
  },
